...
class Settings(BaseSettings):
    ...
    # Background Workers (for single-pod mode)
    num_operation_workers: int = Field(default=3, ge=1, le=10, description="Number of concurrent operation workers")
    status_sync_interval: int = Field(default=30, ge=10, le=300, description="Status sync interval in seconds")
